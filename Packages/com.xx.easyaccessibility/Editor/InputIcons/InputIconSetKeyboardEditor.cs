...
namespace EasyAccessibility
{
    ...
    public class InputIconSetKeyboardEditor : UnityEditor.Editor
    {
        ...
        {
            ("Letters", "<Keyboard>/a", "A"),
            ("Letters", "<Keyboard>/b", "B"),
            ("Letters", "<Keyboard>/c", "C"),
            ("Letters", "<Keyboard>/d", "D"),
            ("Letters", "<Keyboard>/e", "E"),
            ("Letters", "<Keyboard>/f", "F"),
            ("Letters", "<Keyboard>/g", "G"),
            ("Letters", "<Keyboard>/h", "H"),
            ("Letters", "<Keyboard>/i", "I"),
            ("Letters", "<Keyboard>/j", "J"),
            ("Letters", "<Keyboard>/k", "K"),
            ("Letters", "<Keyboard>/l", "L"),
            ("Letters", "<Keyboard>/m", "M"),
            ("Letters", "<Keyboard>/n", "N"),
            ("Letters", "<Keyboard>/o", "O"),
            ("Letters", "<Keyboard>/p", "P"),
            ("Letters", "<Keyboard>/q", "Q"),
            ("Letters", "<Keyboard>/r", "R"),
            ("Letters", "<Keyboard>/s", "S"),
            ("Letters", "<Keyboard>/t", "T"),
            ("Letters", "<Keyboard>/u", "U"),
            ("Letters", "<Keyboard>/v", "V"),
            ("Letters", "<Keyboard>/w", "W"),
            ("Letters", "<Keyboard>/x", "X"),
            ("Letters", "<Keyboard>/y", "Y"),
            ("Letters", "<Keyboard>/z", "Z"),
            ("Digits", "<Keyboard>/digit0", "0"),
            ("Digits", "<Keyboard>/digit1", "1"),
            ("Digits", "<Keyboard>/digit2", "2"),
            ("Digits", "<Keyboard>/digit3", "3"),
            ("Digits", "<Keyboard>/digit4", "4"),
            ("Digits", "<Keyboard>/digit5", "5"),
            ("Digits", "<Keyboard>/digit6", "6"),
            ("Digits", "<Keyboard>/digit7", "7"),
            ("Digits", "<Keyboard>/digit8", "8"),
            ("Digits", "<Keyboard>/digit9", "9"),
            ...
            ("Function", "<Keyboard>/f1", "F1"),
            ("Function", "<Keyboard>/f2", "F2"),
            ("Function", "<Keyboard>/f3", "F3"),
            ("Function", "<Keyboard>/f4", "F4"),
            ("Function", "<Keyboard>/f5", "F5"),
            ("Function", "<Keyboard>/f6", "F6"),
            ("Function", "<Keyboard>/f7", "F7"),
            ("Function", "<Keyboard>/f8", "F8"),
            ("Function", "<Keyboard>/f9", "F9"),
            ("Function", "<Keyboard>/f10", "F10"),
            ("Function", "<Keyboard>/f11", "F11"),
            ("Function", "<Keyboard>/f12", "F12"),
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_showPreview = EditorGUILayout.Foldout(
                m_showPreview,
                "Icon Preview",
                true,
