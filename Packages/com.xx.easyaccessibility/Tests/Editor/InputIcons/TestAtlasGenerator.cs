...
namespace EasyAccessibility.Tests
{
    ...
    {
        const string k_OutputDir =
            "Packages/com.xx.easyaccessibility/Tests/Editor/InputIcons/TestAtlases";
        ...
        public static void Step1_CreateSprites()
        {
            ...
            Debug.Log(
                "[TestAtlasGenerator] Step 1 done: sprites created. Now run Step 2 to pack atlases."
            );
        }
        ...
        public static void Step2_PackAtlases()
        {
            ...
            {
                Debug.LogError(
                    $"[TestAtlasGenerator] '{k_OutputDir}' could not be registered. Run Step 1 first."
                );
                return;
            }
        ...
        static IEnumerable<(string atlasName, string[] spriteNames)> Definitions() =>
            new[]
            {
        ...
        static readonly string[] k_XboxSprites =
        {
            ...
            "xbox_button_start",
            "xbox_button_back", // Xbox 360
            "xbox_button_menu",
            "xbox_button_view", // Xbox One / Series
        ...
        static readonly string[] k_SteamDeckSprites =
        {
            ...
            // Left stick
            "steamdeck_stick_l",
            "steamdeck_stick_l_up",
            "steamdeck_stick_l_down",
            "steamdeck_stick_l_left",
            "steamdeck_stick_l_right",
            "steamdeck_stick_l_press",
            // Right stick
            "steamdeck_stick_r",
            "steamdeck_stick_r_up",
            "steamdeck_stick_r_down",
            "steamdeck_stick_r_left",
            "steamdeck_stick_r_right",
