...
namespace EasyAccessibility.Tests.Colorblind
{
    public class ColorblindSimulationBuiltInTests
    {
        ...
        static readonly FieldInfo k_RenderMaterial =
            typeof(ColorblindSimulationBuiltIn).GetField("m_renderMaterial", BindingFlags.NonPublic | BindingFlags.Instance);
        static readonly FieldInfo k_OverrideSettings =
            typeof(ColorblindSimulationBuiltIn).GetField("overrideSettings", BindingFlags.NonPublic | BindingFlags.Instance);
        static readonly FieldInfo k_Mode =
            typeof(ColorblindSimulationBuiltIn).GetField("mode", BindingFlags.NonPublic | BindingFlags.Instance);
        static readonly FieldInfo k_Amount =
            typeof(ColorblindSimulationBuiltIn).GetField("amount", BindingFlags.NonPublic | BindingFlags.Instance);
        static readonly MethodInfo k_OnRenderImage =
            typeof(ColorblindSimulationBuiltIn).GetMethod("OnRenderImage", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        Material MakeMaterial() => Track(new Material(Shader.Find("EasyAccessibility/BuiltIn/ColorblindSimulation")));
